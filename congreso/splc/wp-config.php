...
define('DB_NAME', 'jornadas');

/** MySQL database username */
define('DB_USER', 'variability');

/** MySQL database password */
define('DB_PASSWORD', 'variability_is_strong_in_you');
...
define('WP_HOME', 'http://localhost:50000');

define('WP_SITEURL', 'http://localhost:50000');
